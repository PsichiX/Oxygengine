...
impl WebPrototypeApp {
    ...
    pub fn clear_color(mut self, value: Rgba) -> Self {
        self.clear_color = value;
        self
    }

    pub fn sprite_filtering(mut self, value: ImageFiltering) -> Self {
        self.sprite_filtering = value;
        self
    }

    pub fn view_size(mut self, value: Scalar) -> Self {
        self.view_size = value;
        self
    }

    pub fn preload_asset(mut self, path: impl ToString) -> Self {
...
fn make_inputs(canvas_id: &str) -> impl FnMut(&mut InputController) + '_ {
    |input| {
