...
impl State for GameState {
    fn on_enter(&mut self, universe: &mut Universe) {
        let mut inputs = universe.expect_resource_mut::<InputController>();

        inputs.map_axis("mouse-x", "mouse", "x");
        inputs.map_axis("mouse-y", "mouse", "y");
        inputs.map_trigger("mouse-action", "mouse", "left");

        inputs.map_axis("move-left", "keyboard", "KeyA");
        inputs.map_axis("move-right", "keyboard", "KeyD");
        inputs.map_axis("move-up", "keyboard", "KeyW");
        inputs.map_axis("move-down", "keyboard", "KeyS");
