...
widget_component! {
    pub menu(id, key, state, animator) [use_nav_container_active, use_menu] {
        ...
        let background_props = ImageBoxProps {
            material: ImageBoxMaterial::Color(ImageBoxColor {
                color: Color { r: 1.0, g: 1.0, b: 1.0, a: 0.65 * phase },
                ..Default::default()
            }),
            ..Default::default()
        };
        ...
        let bar_props = Props::new(ContentBoxProps {
            transform: Transform {
                align: Vec2 { x: 0.0, y: 1.0 - phase },
                ..Default::default()
            },
            ..Default::default()
        }).with(ContainerProps {
            variant: "black".to_owned(),
            canvas_color: Some(Color { r: 0.2, g: 0.2, b: 0.2, a: 1.0 }),
            ..Default::default()
        }).with(ContentBoxItemLayout {
            anchors: Rect {
                left: 0.0,
