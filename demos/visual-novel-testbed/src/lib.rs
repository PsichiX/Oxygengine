...
use oxygengine::{prelude::*, user_interface::raui::core::application::ProcessContext};
...
pub fn main_js() -> Result<(), JsValue> {
    ...
    let app = App::build::<LinearPipelineBuilder>()
        ...
        .with_bundle(
            ...
            UserInterfaceBundleSetup::default()
                .user_interface(
                    UserInterface::new(
                        oxygengine::integration_visual_novel_user_interface::ui_setup,
                    )
                ...
                .process_context_setup(ui_process_context_setup),
        )
        .unwrap()
...
fn ui_process_context_setup(universe: &Universe, process_context: &mut ProcessContext) {
    oxygengine::integration_visual_novel_user_interface::ui_process_context_setup(
        universe,
        process_context,
    );
}
